...
return [
  ...
  'turnstile' => [
    ...
    'mwform'    => [
      ...
      'html'              => <<<HTML
      <div class="u-ta_center">[mwform_hidden name="turnstile-check" value="1"][mwform_error keys="turnstile-check"]</div>
      <div
        class="cf-turnstile"
        style="
          display: flex;
